...
// ── Data ──────────────────────────────────────────────────────────────────────
const CHANGELOG = [
    { version:'26.9.3', date:'25th September 2026', type:'update',  title:'Ceremony Polish',        description:'Polished the new result ceremony and rebalanced the new items', changes:['Added more stats to the result screen', 'Polished the result ceremony and lowered its volume', 'Rebalanced the new 26.3 items', 'Moved the Sulfur Cube Bucket out of the "Stone & Bricks" collection category', 'Op transparency now only reports op commands'] },
    { version:'26.9.2', date:'24th September 2026', type:'feature', title:'New Items & Result Ceremony', description:'Added the 26.3 items and a new result reveal', changes:['Added the new 26.3 items to the item pools: the poplar wood set, cushions, wool and concrete slabs & stairs, and all explorer maps', 'Added a new collection book category for maps', 'Reworked the result reveal into a new ceremony', 'Added the Dappled Forest as a spawn biome for /reset', 'Fixed back-to-back chain odds being attached to the previous find instead of the current one', 'Fixed interactions while the game is paused'] },
    { version:'26.9.1', date:'18th September 2026', type:'update',  title:'Locators & 26.3',        description:'Updated the server to 26.3 and improved the locators', changes:['Updated the server to Minecraft 26.3', 'The Sulfur Locator now scans caves to find sulfur biomes underground', 'Locators now point to the actually nearest structure (works around Minecraft bug MC-138887)', 'Fixed /bp', 'Fixed the LEGENDARY achievement and achievements with an apostrophe in their name', 'Wide-range code clean up and tests for every command'] },
    { version:'26.8.5', date:'31st August 2026',   type:'update',  title:'Under the Hood',         description:'Code clean up and automated tests', changes:['Added an automated test suite that runs on every change', 'Various code clean ups'] },
    { version:'26.8.4', date:'30th August 2026',   type:'fix',     title:'Team Fixes',             description:'Fixed team related bugs', changes:['Fixed back-to-back rarity not being shared within a team', 'Fixed spectators counting towards teleporter stats', 'Team pairing history now lives in its own config file so it survives config updates'] },
    { version:'26.8.3', date:'29th August 2026',   type:'feature', title:'Fresh Teams',            description:'Random teams avoid repeating pairs', changes:['Team creation now avoids pairs that already played together in previous rounds', 'Fixed the Eye of Antimatter', 'Reverted the latest changes to the Antimatter Locator recipe'] },
    { version:'26.8.2', date:'6th August 2026',    type:'major',   title:'Antimatter Depths Rework', description:'Reworked the Antimatter Depths and added a Trail Ruins locator', changes:['Reworked the Antimatter Depths: open a private portal in the overworld ruin with a Totem of Antimatter', 'Entering the End now uses the new structure', 'Added the Kiln-Fired Brush, a locator for Trail Ruins that only works on soil', 'Moved the Trail Ruins items into the late pool'] },
    { version:'26.8.1', date:'3rd August 2026',    type:'feature', title:'Eye of Antimatter',      description:'Added the Eye of Antimatter', changes:['Added the Eye of Antimatter as a Cleric trade, needed for the new Antimatter Locator recipe', 'Added a timer for the PointHunt event', 'Added a world clock to the tab list'] },
    { version:'26.7.9', date:'31st July 2026',     type:'update',  title:'Clean up & QOL additions', description:'Quality of life improvements and bug fixes', changes:['The result screen now shows who found each item in team games', 'Fixed a critical bug on game start', 'Fixed a visual bug in /forceteam', 'Various code clean ups'] },
    { version:'26.7.8', date:'29th July 2026',     type:'update',  title:'Additions & Bug Fixes',  description:'Reworked locator visuals', changes:['Added PointHunt as a random event', 'The link to the match stats now gets pasted when the games has finished', 'Teleporters can now be used after the game has ended', 'Fixed the wandering trader respawning too early', 'Fixed various bugs' ]},
