            ...
            >
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <span style={{ color: COLORS.text, fontSize: '13px' }}>
                                    Spins #{luckRating.peakWindowRange.start?.toLocaleString()} – #{luckRating.peakWindowRange.end?.toLocaleString()}
                                </span>
                ...
                {luckRating?.stats && (
                    <div style={{
                        ...
                        {luckRating.stats.totalSpins?.toLocaleString()} total spins · Both normal and lucky spins count
                    </div>
                )}
            </div>
        </div>
